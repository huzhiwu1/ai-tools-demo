...
exports.ConversationsServiceEnhanced = void 0;
...
let ConversationsServiceEnhanced = class ConversationsServiceEnhanced {
    em;
    embeddings = null;
    constructor(em) {
        this.em = em;
    ...
    async createMessage(dto) {
        ...
        const message = this.em.create(message_entity_1.Message, {
            ...dto,
            embedding,
        });
    ...
    getEmbeddings() {
        if (!this.embeddings) {
            if (!process.env.OPENAI_API_KEY) {
                throw new common_1.BadRequestException('语义检索需要配置 OPENAI_API_KEY');
            }
...
exports.ConversationsServiceEnhanced = ConversationsServiceEnhanced;
exports.ConversationsServiceEnhanced = ConversationsServiceEnhanced = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectEntityManager)()),
    __metadata("design:paramtypes", [typeorm_2.EntityManager])
], ConversationsServiceEnhanced);
//# sourceMappingURL=conversations.service.enhanced.js.map